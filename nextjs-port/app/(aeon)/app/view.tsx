  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <PageHeader
        ...
        actions={
          <>
            <Link href="/app/builds"><Button variant="outline" className="gap-1.5"><Package className="size-3.5" /> Upload build</Button></Link>
            <Link href="/app/testing"><Button className="gap-1.5"><Rocket className="size-3.5" /> Run test</Button></Link>
          </>
        }
      />
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-border/70 bg-card lg:col-span-2">
          <div className="flex items-center justify-between border-b border-border/60 px-4 py-3">
            ...
            <Link href="/app/testing" className="text-xs text-muted-foreground hover:text-foreground">View all →</Link>
          </div>
      ...
      <div className="rounded-xl border border-border/70 bg-card p-4">
        ...
        <div className="mt-3 flex items-center justify-between text-xs text-muted-foreground">
          ...
          <Link href="/app/billing" className="inline-flex items-center gap-1 text-foreground hover:underline">Manage <ArrowUpRight className="size-3" /></Link>
        </div>
      </div>
    </div>
  );
