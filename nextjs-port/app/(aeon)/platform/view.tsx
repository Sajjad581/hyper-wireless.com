          ...
          <div className="grid gap-10 md:grid-cols-[1fr_1.4fr] md:items-center">
            <div>
              ...
              <div className="mt-6 flex gap-3">
                <Link href="/docs"><Button variant="outline">API reference</Button></Link>
                <Link href="/app/tokens"><Button variant="ghost" className="gap-2"><Terminal className="size-4" /> Manage tokens</Button></Link>
              </div>
            </div>
      ...
      <section className="border-b border-border/60">
        <div className="mx-auto max-w-5xl px-6 py-20 text-center">
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <Link href="/register"><Button size="lg">Create free workspace</Button></Link>
            <Link href="/workflow"><Button size="lg" variant="outline" className="gap-2"><Workflow className="size-4" /> See the workflow</Button></Link>
          </div>
        </div>
      </section>
