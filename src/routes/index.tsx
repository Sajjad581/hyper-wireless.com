        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Link to="/register"><Button size="lg" className="gap-2">Start free trial <ArrowRight className="size-4" /></Button></Link>
          ...
          <div className="grid gap-10 md:grid-cols-[1fr_1.3fr] md:items-center">
            <div>
              ...
              <div className="mt-6 flex gap-3">
                <Link to="/platform"><Button variant="outline">See platform</Button></Link>
