    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The route you requested does not exist in AEON Cloud.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "AEON Cloud" },
      { property: "og:site_name", content: "AEON Cloud" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              "@id": "https://aeon-cloud-connect.lovable.app/#organization",
              name: "AEON Cloud",
              url: "https://aeon-cloud-connect.lovable.app",
              logo: "https://aeon-cloud-connect.lovable.app/favicon.ico",
              description:
                "Cloud-based 3GPP UE certification platform. A digital testbench for TTCN-3 conformance on SDR-backed lanes.",
            },
            {
              "@type": "WebSite",
              "@id": "https://aeon-cloud-connect.lovable.app/#website",
              url: "https://aeon-cloud-connect.lovable.app",
              name: "AEON Cloud",
              publisher: { "@id": "https://aeon-cloud-connect.lovable.app/#organization" },
            },
          ],
        }),
      },
